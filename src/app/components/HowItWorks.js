    ...
    <div className="max-w-7xl   md:text-2xl  rounded-2xl flex items-center flex-col  bg-[#F9A03ECC] bg-opacity-80 shadow-xl py-4 ">
      ...
      <div className="w-full h-full grid grid-cols-4 space-x-4 px-4 md:px-20  md:pb-10 text-sm">
        <div className="bg-black rounded-3xl  h-56 flex items-center flex-col px-4 ">
          ...
          <div className="text-white flex items-center h-full justify-center my-4 font-pretendard text-3xl ">
        ...
        <div className="bg-black rounded-3xl  h-56 flex items-center flex-col px-4 mt-20">
          ...
          <div className="text-white flex items-center h-full justify-center my-4 font-pretendard ">
        ...
        <div className="bg-black rounded-3xl  h-56 flex items-center flex-col px-4 mt-20 ">
          ...
          <div className="text-white flex items-center h-full justify-center my-4 font-pretendard ">After 14 days users can withdraw the staked funds.</div>
        </div>
      </div>
    </div>
  );
